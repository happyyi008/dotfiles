# Defined in /usr/local/Cellar/fish/2.7.1/share/fish/functions/fish_vi_key_bindings.fish @ line 1
function custom_vi --description 'vi-like key bindings for fish'
  if contains -- -h $argv
